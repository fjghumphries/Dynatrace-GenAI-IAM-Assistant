...
# ============================================================================
# Lesson #21: ONE binding resource per group.
# Lesson #19: Default data read policies REQUIRED for bucket access.
#
# Application boundaries enumerate stages (e.g., bu1-prod-petclinic01,
# bu1-dev-petclinic01). Default data read policies + boundaries provide
