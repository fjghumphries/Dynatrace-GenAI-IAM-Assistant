...
#
# gotcha #2:  Boundaries decouple "What" from "Where"
# gotcha #8:  Storage vs settings use different condition namespaces
# gotcha #18: All values lowercase for Grail bucket compatibility
# ============================================================================
