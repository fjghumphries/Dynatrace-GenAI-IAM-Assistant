...
# Custom Policies
# ============================================================================
# gotcha #16: Admin Features replaces Admin User — no unconditional settings write
# gotcha #17: hub:catalog-items:install and activegate:* are NOT valid identifiers
# gotcha #20: Feature permissions (automation, slo, extensions, app-engine) are
#             tenant-wide — cannot be scoped by security_context
# gotcha #22: OpenPipeline is now managed via Settings 2.0 (builtin:openpipeline.*)
...
# Intentionally excludes .routing and .pipeline-groups schemas (gotcha #22).
