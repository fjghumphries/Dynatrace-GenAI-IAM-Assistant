...
# BU-Level Bindings
# ============================================================================
# gotcha #21: ONE binding resource per group — multiple resources overwrite.
# gotcha #19: Default data read policies REQUIRED for Grail bucket access.
# gotcha #20: Admin Features permissions are tenant-wide (cannot scope).
#
...
resource "dynatrace_iam_policy_bindings_v2" "bu_admins" {
  ...
  # --- Default data read policies (bucket access — gotcha #19) ---
  policy {
